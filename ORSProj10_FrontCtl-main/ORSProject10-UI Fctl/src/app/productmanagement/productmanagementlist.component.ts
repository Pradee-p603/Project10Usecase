...
@Component({
  selector: "app-productmanagementlist",
  templateUrl: "./productmanagementlist.component.html",
  styleUrls: ["./productmanagementlist.component.css"],
})
export class ProductmanagementlistComponent extends BaseListCtl implements OnInit {
  ...
  formatDate(event: any) {
    ...
    this.form.searchParams.dateOfPurchase = formattedDate;
  }
